"""
Django settings for myshopConfig project.
...
SECRET_KEY = '7y#!e@nt4hn)1emnq#*_@7=2ytupt(+-(47)0!f(rcu_2$et8z'
...
ROOT_URLCONF = 'myshopConfig.urls'
...
WSGI_APPLICATION = 'myshopConfig.wsgi.application'
